...
import com.ly.imart.maxim.common.bean.UserBean;
...
import com.ly.imart.maxim.common.view.SplashVideoPlayView;
import com.ly.imart.maxim.push.NotificationUtils;
import com.ly.imart.maxim.sdk.utils.MessageDispatcher;
...
// 修改iMart             MaximMainActivity.openMain(WelcomeActivity.this);
                        MainActivity.openIMart(WelcomeActivity.this);
                        finish();
                    }
                });
    }
