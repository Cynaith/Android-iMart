...
public class ArticleMainModelImpl implements IArticleMainModel {
    ...
    private ArticleMainBean articleMainBean;

    public ArticleMainModelImpl() {
         articleMainBean = new ArticleMainBean();
    }

    @Override
    public ArticleMainBean getInfo(String userPhone) {
        articleMainBean.setUsername("Tom Jackson");
        articleMainBean.setContent( "            <p><strong>本文作者为李迅雷，来源于微信公众号<a href=\"http://mp.weixin.qq.com/s?__biz=MzIyMTE0NjExMA==&amp;mid=2649619491&amp;idx=1&amp;sn=388f352821e853690066180966d039f2&amp;scene=23&amp;srcid=0417U7bOeAn8wQTbI9JjmnPo#rd\">lixunlei0722</a>。</strong></p>\n" +
                "\n" +
