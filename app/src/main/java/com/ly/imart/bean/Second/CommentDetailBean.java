...
public class CommentDetailBean {
    ...
    public CommentDetailBean(int id, int userId, String nickName, String userLogo, String content, String imgId, int replyTotal, String createDate, List<ReplyDetailBean> replyList) {
        this.id = id;
        this.userId = userId;
