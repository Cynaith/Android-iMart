...
public class AddArticleActivity extends Activity {
    ...
    /**
     * 自定义menu https://www.cnblogs.com/Peter-Chen/p/6421354.html
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.others_add_article);
    ...
    private Toolbar prepareToolbar(TextViewToolbar toolbar, Icarus icarus) {
        Typeface iconfont = Typeface.createFromAsset(getAssets(), "font/Simditor.ttf");
        ...
        if (id == R.id.action_set_content) {
            ...
            icarus.setContent(
                    "            <p><strong>本文作者为李迅雷，来源于微信公众号<a href=\"http://mp.weixin.qq.com/s?__biz=MzIyMTE0NjExMA==&amp;mid=2649619491&amp;idx=1&amp;sn=388f352821e853690066180966d039f2&amp;scene=23&amp;srcid=0417U7bOeAn8wQTbI9JjmnPo#rd\">lixunlei0722</a>。</strong></p>\n" +
                            ...
                            "\n" +
                            "<p><img alt=\"1\" src=\"http://http://a3.att.hudong.com/14/75/01300000164186121366756803686.jpg\"></p>\n" +
                            "\n" +
                            "<p>海通期货研究员杨娜供图&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>\n" +
                            "\n" +
                            ...
                            "\n" +
                            "<p><img alt=\"2\" src=\"http://a3.att.hudong.com/14/75/01300000164186121366756803686.jpg\"></p>\n" +
                            "\n" +
                            ...
                            "\n" +
                            "<p><img alt=\"3\" src=\"http://a3.att.hudong.com/14/75/01300000164186121366756803686.jpg\"></p>\n" +
                            "\n" +
