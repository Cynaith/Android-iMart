...
public class SecondFragmentViewpage1 extends Fragment {
    private View view;
    private OneRecyclerView mOneRecyclerView;

//    @BindView(R.id.second_fragment_viewPager1_list_imageview)
    MyImageView imageView;

//    @BindView(R.id.second_fragment_viewPager1_list_name)
    TextView textView_name;

//    @BindView(R.id.second_fragment_viewPager1_list_price)
    TextView textView_price;

//    @BindView(R.id.second_fragment_viewPager1_list_fire)
    TextView textView_fire;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.second_fragment_viewpage1, container, false);

        mOneRecyclerView = (OneRecyclerView) view.findViewById(R.id.second_fragment_viewPager1_list);
    ...
    class SecondFragmentBeanVH extends OneVH<SecondFragmentBean>{
        public SecondFragmentBeanVH(ViewGroup parent) {
            super(parent, R.layout.second_fragment_viewpage1_list);
        }
...
//                    Toast.makeText(view.getContext(),""+secondFragmentBean.getName(),Toast.LENGTH_SHORT).show();
            ...
            imageView = (MyImageView) itemView.findViewById(R.id.second_fragment_viewPager1_list_imageview);
    ...
    private List<SecondFragmentBean> fetchData(){
        ...
        try {
            listBeans = secondFragmentViewPageModel.getKindArticle(1);
        } catch (ExecutionException e) {
            e.printStackTrace();
        } catch (InterruptedException e) {
            e.printStackTrace();
